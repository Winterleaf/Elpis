namespace Elpis.Lpfm.LastFmScrobbler.Api
{
    ...
    ///     <see cref="http://www.last.fm/api/scrobbling">Last.fm Track web service</see>
    /// </summary>
    public interface ITrackApi
    {
        ...
        /// <param name="authentication"><see cref="Authentication" /> object</param>
        /// <returns>A <see cref="ScrobbleResponse" />DTO containing details of Last.FM's response</returns>
        ScrobbleResponses Scrobble(System.Collections.Generic.IList<Track> tracks, Authentication authentication);
        ...
        /// <param name="authentication"><see cref="Authentication" /> object</param>
        /// <returns>A <see cref="ScrobbleResponse" />DTO containing details of Last.FM's response</returns>
        ScrobbleResponses Scrobble(System.Collections.Generic.IList<Track> tracks, string context,
