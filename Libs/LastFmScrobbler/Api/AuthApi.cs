namespace Lpfm.LastFmScrobbler.Api
{
    ...
    internal class AuthApi : IAuthApi
    {
        ...
        protected virtual Session GetSessionFromNavigator(System.Xml.XPath.XPathNavigator navigator)
        {
        ...
        public AuthenticationToken GetToken(Authentication authentication)
        {
            ...
            System.Xml.XPath.XPathNavigator navigator = RestApi.SendGetRequest(ApiHelper.LastFmWebServiceRootUrl,
                parameters);
        ...
        {
            System.Collections.Generic.Dictionary<string, string> parameters = new System.Collections.Generic.Dictionary<string, string> {{"token", token.Value}};
