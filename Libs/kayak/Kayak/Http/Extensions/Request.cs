namespace Kayak.Http.Extensions
{
    public static partial class Extensions
    {
        ...
        {
            return request.Version != null && request.Version.Major == 1 && request.Version.Minor == 1 &&
                   request.Headers != null && request.Headers.ContainsKey("expect") &&
                   request.Headers["expect"] == "100-continue";
        }

        private static bool IsContinueProhibited(this HttpRequestHead request)
        {
